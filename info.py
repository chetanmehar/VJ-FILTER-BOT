...
API_ID = int(environ.get('API_ID', '21763447'))
API_HASH = environ.get('API_HASH', '3a09cb607be1ee9aead708d986e7d31d')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://chetanmehar581:cURMqNaihtrikHwR@meharmovie.v4zvytq.mongodb.net/?retryWrites=true&w=majority&appName=Meharmovie")
DATABASE_NAME = environ.get('DATABASE_NAME', "Meharmovie")
...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Promotion990') # owner username without @
